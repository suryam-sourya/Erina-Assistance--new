    ...
    <section id="stories" className="py-24 bg-white dark:bg-[#0B0F19] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              >
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-100 dark:border-gray-800/60 mt-auto">
                  ...
                  <div className="text-right">
                    <span className="block text-[10px] text-foreground/40 font-bold uppercase tracking-wider">Technician</span>
        ...
        >
          ...
          <a
            href="/booking"
            className="flex items-center justify-center gap-2 bg-primary hover:bg-primary-hover text-white px-8 py-4 rounded-xl font-bold text-base shadow-lg shadow-primary/30 transition-all whitespace-nowrap"
          >
