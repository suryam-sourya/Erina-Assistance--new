...
const zones = [
  ...
  { name: 'Hebbal & Yelahanka', status: 'Active', active: true },
  { name: 'Electronic City', status: 'Active', active: true },
  { name: 'Koramangala & HSR Layout', status: 'Active', active: true },
  { name: 'Bannerghatta Road', status: 'Active', active: true },
  { name: 'NICE Road & ORR', status: 'Active', active: true },
  { name: 'Nandi Hills Highway', status: 'Active', active: true },
