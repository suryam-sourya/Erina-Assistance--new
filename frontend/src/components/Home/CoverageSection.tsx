...
const zones = [
  ...
  { name: 'Hebbal & Yelahanka', status: 'Coming Soon', active: true },
  { name: 'Electronic City', status: 'Coming Soon', active: true },
  { name: 'Koramangala & HSR Layout', status: 'Coming Soon', active: true },
  { name: 'Bannerghatta Road', status: 'Coming Soon', active: true },
  { name: 'NICE Road & ORR', status: 'Coming Soon', active: true },
  { name: 'Nandi Hills Highway', status: 'Coming Soon', active: true },
